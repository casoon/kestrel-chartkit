...
pub struct CompositeSignal {
    ...
    pub score: f64,
    /// 0..1 — share of subscores agreeing with `direction`.
    ///
    /// Named `confidence` until 2026-09-08; it is computed as
    /// `agreeing / total` and never was a win probability. Same reasoning
    /// as `scoring::Agreement::agreement`.
    pub agreement: f64,
